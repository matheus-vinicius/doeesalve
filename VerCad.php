...
<body>
    ...
    <header  class="container-fluidx "class="container-fluidx">
            ...
            <tbody class="text-center">
                <?php 
                    while($linha = mysqli_fetch_array($resultado)) {
                        echo "
                            <tr>
                                <td class='text-center'>".$linha['cep']." </td>
                                <td class='text-center'>".$linha['logradouro']."</td>
                                <td class='text-center'>".$linha['num']."</td>
                                <td class='text-center'>".$linha['compl']." </td>
                                <td class='text-center'>".$linha['bairro']." </td>
                                <td class='text-center'>".$linha['cidade']." </td>
                                <td class='text-center'>".$linha['uf']." </td>
                                <td class='text-center'>
                                    <form action='VerCad_Update.php' method='POST'>
                                        ...
                                        <input type='hidden' name='cep' value=".$linha['cep'].">
                                        <input type='hidden' name='logradouro' value=".$linha['logradouro'].">
                                        <input type='hidden' name='num' value=".$linha['num'].">
                                        <input type='hidden' name='compl' value=".$linha['compl'].">
                                        <input type='hidden' name='bairro' value=".$linha['bairro'].">
                                        <input type='hidden' name='cidade' value=".$linha['cidade'].">
                                        <input type='hidden' name='uf' value=".$linha['uf'].">
    ...
    <section class="intro-section2">
        <div class="container">
            <div class="row">
                ...
                <div class="mx-auto" style=width: "200px;">
                    <a href="VerCad4.php" class="read-more"><h3 style="color:#000; margin-top: 60px">Alterar senha</h3></a>
                </div>
