            ...
            <tbody class="text-center">
                <?php 
                    while($linha = mysqli_fetch_array($resultado)) {
                        echo "
                            <tr>
                                <td class='text-center'>".$linha['tel']." </td>
                                <td class='text-center'>".$linha['telcom']."</td>
                                <td class='text-center'>".$linha['cel']."</td>
                                <td class='text-center'>
                                    <form action='VerCad2_Update.php' method='POST'>
                                        ...
                                        <input type='hidden' name='tel' value=".$linha['tel'].">
                                        <input type='hidden' name='telcom' value=".$linha['telcom'].">
                                        <input type='hidden' name='cel' value=".$linha['cel'].">
                                    </form>
                                </td>
                            </tr>
                        ";
