                    ...
                    while($linha = mysqli_fetch_array($resultado)) {
                        echo "
                            <tr>
                                ...
                                <td class='text-center'>".$linha['hemocentro']." </td>
                                <td class='text-center'>".$linha['data']."</td>
                                <td class='text-center'>".$linha['hora']."</td>
                                        <input type='hidden' name='id_usuario' value=".$linha['id_usuario'].">
                                        <input type='hidden' name='hemocentro' value=".$linha['hemocentro'].">
                                        <input type='hidden' name='data' value=".$linha['data'].">
                                        <input type='hidden' name='hora' value=".date('h:m', strtotime($linha['hora'])).">

                                    </form>
                                </td>
                                <td>
                                <form action='DelAgend.php' method='POST'>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="mx-auto" style=width: "100px;">
                    <a href="ControleADM1.php" class="read-more"><h3 style="color:#000; margin-top: 60px">Usuários</h3></a>
                </div>
