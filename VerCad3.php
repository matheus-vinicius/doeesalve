...
<div class="d-flex">
        ...
        <table class="table table-hover">
            <thead>
                <tr>
                    <th class="text-center">Contato de Emergência 1</th>
                    <th class="text-center">RG do Contato de Emergência 1</th>
                    <th class="text-center">Celular do Contato de Emergência 1</th>
                    <th class="text-center">Email do Contato de Emergência 1</th>
                    <th class="text-center">Contato de Emergência 2</th>
                    <th class="text-center">RG do Contato de Emergência 2</th>
                    <th class="text-center">Celular do Contato de Emergência 2</th>
                    <th class="text-center">Email do Contato de Emergência 2</th>
                    <th></th>
                </tr>
            </thead>
            <tbody class="text-center">
                <?php 
                    while($linha = mysqli_fetch_array($resultado)) {
                        echo "
                            <tr>
                                <td class='text-center'>".$linha['nomeem1']." </td>
                                <td class='text-center'>".$linha['rgem1']."</td>
                                <td class='text-center'>".$linha['celem1']."</td>
                                <td class='text-center'>".$linha['emailem1']."</td>
                                <td class='text-center'>".$linha['nomeem2']." </td>
                                <td class='text-center'>".$linha['rgem2']."</td>
                                <td class='text-center'>".$linha['celem2']."</td>
                                <td class='text-center'>".$linha['emailem2']."</td>
                                <td class='text-center'>
                                    <form action='VerCad3_Update.php' method='POST'>
                                        ...
                                        <input type='hidden' name='nomeem1' value=".$linha['nomeem1'].">
                                        <input type='hidden' name='rgem1' value=".$linha['rgem1'].">
                                        <input type='hidden' name='celem1' value=".$linha['celem1'].">
                                        <input type='hidden' name='emailem1' value=".$linha['emailem1'].">
                                        <input type='hidden' name='nomeem2' value=".$linha['nomeem2'].">
                                        <input type='hidden' name='rgem2' value=".$linha['rgem2'].">
                                        <input type='hidden' name='celem2' value=".$linha['celem2'].">
                                        <input type='hidden' name='emailem2' value=".$linha['emailem2'].">
                                    </form>
                                </td>
                            </tr>
                        ";
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="mx-auto" style=width: "200px;">
                    <a href="VerCad3.php" class="read-more"><h3 style="color:#000; margin-top: 60px">Verificar contatos de emergência</h3></a>
                </div>
